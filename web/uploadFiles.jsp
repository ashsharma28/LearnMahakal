...
<jsp:include page="header.html"></jsp:include>
    ...
    <form action="uploadFiles.jsp" method="post" enctype="multipart/form-data">
           ...
           <%
                ...
                out.append("<option value=\"").append(subject1).append("\">");
                out.append(subject1);
                out.append("</option>\n");

                out.append("<option value=\"").append(subject2).append("\">");
                out.append(subject2);
                out.append("</option>\n");

                out.append("<option value=\"").append(subject3).append("\">");
                out.append(subject3);
               out.append("</option>\n");

                out.append("<option value=\"").append(subject4).append("\">");
                out.append(subject4);
               out.append("</option>\n");
    ...
    <%
        ...
        if (request.getMethod().equalsIgnoreCase("POST"))
        {
            ...
            Exception exception = controller.addFile(con, subject, description, path);
